...
$(function() {
var cor='<div> Coordinadora<br><a  data-toggle="modal" data-target=".bd-cutai01-modal-lg" style="cursor: pointer;">Mtra. Yadira del Carmen Rosales Ruiz.</a>'
...
var Dat='<div> Oficial <br><a  data-toggle="modal" data-target=".bd-cutai04-modal-lg" style="cursor: pointer;">Mtra. Elizabeth Ramzahuer Villa.</a></div>'
var datascource = {
...
'createNode': function($node, data) {
    ...
    var secondMenu = '<div class="second-menu"><img class="avatar" src="https://rabravo-uv.github.io/CutAI/img/cutai' + data.id + '.jpg"></div>';
